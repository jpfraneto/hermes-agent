...
class GatewayRunner:
    ...
    async def _handle_message(self, event: MessageEvent) -> Optional[str]:
        ...
        # Plain-language messages can also auto-load a skill when a skill opts in
        # via metadata.hermes.auto_trigger_phrases.
        try:
            ...
            if command:
                ...
                auto_skill = build_auto_skill_invocation_message(event.text or "")
                if auto_skill and auto_skill.get("message"):
                    event.text = auto_skill["message"]
        except Exception as e:
